  ...
  return (
    <div className="flex min-h-screen items-start justify-center bg-gray-100 pt-10">
      <form
        ...
        noValidate
        className="w-[420px] rounded-md bg-white p-6 shadow"
      >
        ...
        {/* 姓 */}
        <div className="mb-4">
          <label className="mb-1 block text-sm">姓</label>
        ...
        {/* 名 */}
        <div className="mb-4">
          <label className="mb-1 block text-sm">名</label>
        ...
        {/* 職業 */}
        <div className="mb-4">
          <label className="mb-1 block text-sm">職業</label>
          <Input {...register("occupation")} />
        </div>

        {/* 目的 */}
        <div className="mb-4">
          <label className="mb-1 block text-sm">目的</label>
          <Input {...register("purpose")} />
        </div>

        {/* 誕生日 */}
        <div className="mb-4">
          <label className="mb-1 block text-sm">誕生日</label>
        ...
        {/* 性別 */}
        <div className="mb-6">
          <label className="mb-2 block text-sm">性別</label>
        ...
        {/* 住所 */}
        <div className="mb-6">
          <label className="mb-1 block text-sm">住所</label>
